    ...
    <header className="header">
        ...
        >
          ...
          {showHelp && (
            <div className="help-popover disable-click-outside">
              ...
              <p>Listen to the intro, then find the correct Beatles song in the list.</p>
      ...
      <div className="header-side header-side-right">
        <div className="apple-score" title="Your Lifetime Apple Score!">
          <img src="/apple.jpg" alt="Apples" style={{ width: 18, height: 18, borderRadius: '50%', objectFit: 'cover' }} />
          <span>{apples}</span>
        </div>
      </div>
